...
class CMContent extends CObject implements IHasSQL, ArrayAccess, IModule {
  ...
  public static function SQL($key=null, $args=null) {
    ...
    $queries = array(
              ...
              'select *'                => 'SELECT c.*, u.acronym as owner FROM Content AS c INNER JOIN User as u ON c.idUser=u.id AND deleted IS NULL;',
