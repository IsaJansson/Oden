...
class CCUser extends CObject implements IController {
    ...
    public function Index() {
    	$this->views->SetTitle('User Controller')
    				...
    				'is_authenticated'=>$this->user['isAuthenticated'], 'user'=>$this->user,
    				));
    }
    ...
    public function Login() {
    	...
    	$this->views->SetTitle('Login')
                  ...
                  'login_form' => $form,
                  'allow_create_user' => COden::Instance()->config['create_new_users'],
    ...
    public function DoLogin($form) {
    	$var = $this->user->Login($form['acronym']['value'], $form['password']['value']);
    	$bar = $var;
	    if($bar) {
